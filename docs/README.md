...
<h1 align="center">world park minecraft</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `World-Park-Minecraft-win-x64.exe ` |
| macOS | `World-Park-Minecraft-mac-universal.dmg` |
| Linux x64 | `World-Park-Minecraft-linux-x86_64.AppImage` |
